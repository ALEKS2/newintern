...
$supervisors = Rejectedsupervisor::getRejectedSupervisors($db);
...
<body>
    <div class="mynavbar">
        ...
        <ul class="mynav">
            ...
            <li class="mynav-link">
                <a href="rejected.php" class="myactive">Rejected Requests</a>
            </li>
        </ul>
        ...
        <table class="table table-striped">
            ...
            <?php if($supervisors){
                foreach ($supervisors as $supervisor) {
                    ...
                    <td><?php echo $supervisor['id_number']; ?></td>
                    <td><?php echo $supervisor['organization']; ?></td>
                    <td><?php echo $supervisor['org_website']; ?></td>
                    <td><?php echo $supervisor['reason']; ?></td>
                    </tr>
                    <?php
}
            }  ?>
